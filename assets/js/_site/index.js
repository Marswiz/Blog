...
(() => {
    ...
    new class {
        ...
        refreshContainerElement() {
            ...
            for (let t of this.headers) this.addIndexLinkElement(t, e);
            this.frag = e, this.container.innerHTML = "", this.container.appendChild(e)
        }
        addIndexLinkElement(e, t = this.frag) {
            ...
            let i = this.tags.slice(0, n).join("."),
                d = document.createElement("span");
            d.innerText = `${i}  `, d.classList.add("headerIndexTag");
            let h = document.createElement("span");
            h.innerText = r, a.appendChild(d), a.appendChild(h), a.href = `#${s}`, t.appendChild(a)
        }
